...
//
//
//	Animation<math::Point3D> animation::lissajous(const int x_amplitude, const int y_amplitude, const int z_amplitude, const int x_frequency, const int y_frequency, const int z_frequency,
...
//			auto valueY = y_amplitude * sin(2 * 3.14*y_frequency*now.seconds() + y_phase.radians());
//			auto valueZ = z_amplitude * sin(2 * 3.14*z_frequency*now.seconds() + z_phase.radians());
//
